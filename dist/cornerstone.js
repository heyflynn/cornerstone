/*! cornerstone-core - 2.2.8 - 2021-09-01 | (c) 2016 Chris Hafey | https://github.com/cornerstonejs/cornerstone */
...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "4a2d985ec96ec8549a17";
...
function getColormapsList() {
  ...
  keys.forEach(function (key) {
    if (Object.prototype.hasOwnProperty.call(colormapsData, key)) {
...
/*!***************************!*\
  !*** ./webgl/renderer.js ***!
  \***************************/
/*! exports provided: render, initRenderer, getRenderCanvas, isWebGLAvailable, isWebGLInitialized */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function getShaderProgram(image) {
  ...
  if (Object.prototype.hasOwnProperty.call(_shaders_index_js__WEBPACK_IMPORTED_MODULE_0__["shaders"], datatype)) {
...
function renderQuad(shader, parameters, texture, width, height) {
  ...
  gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT); //gl.useProgram(shader.program)
